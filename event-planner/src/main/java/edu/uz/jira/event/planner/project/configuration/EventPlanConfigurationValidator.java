...
public class EventPlanConfigurationValidator {
     ...
     */
    public boolean containsAnyVersion(final Project project) {
        if (project == null) {
            return false;
        }
     ...
     */
    public boolean isInvalid(final Project project) {
     ...
     */
    public boolean canInputProjectConfiguration(final Project project, final String eventType, final String eventDueDate) {
        return project != null && !containsAnyVersion(project)
     ...
     */
    public boolean canConfigureProject(final Project project, final String eventType, final String eventDueDate) {
        return project != null && !containsAnyVersion(project)
